...
### Timeline
`Futuro Distante` > `Passado` > `Presente` > `10 Anos Depois`

---

### Como Usar
Este repositório usa JSON como base de dados para o mangá.  
Abra o `index.json` para navegar por todo o conteúdo.

© 2026 The Defriends. Todos os direitos reservados.
